...
<div class="grid grid-cols-1 gap-2 sm:grid-cols-2">
  {#each options as option, index}
    <div
      class={`sm:p-3 ring-1 flex sm:flex-col gap-2 sm:gap-3 justify-between transition-all duration-300 rounded-lg sm:rounded-2xl ${itemCounts[index] > 0 ? "bg-orange-50 ring-orange-300" : "bg-white hover:ring-orange-500 ring-slate-200"}`}
    >
      <img
      ...
      <div class="flex py-2 pr-2 sm:pr-0 sm:py-0 flex-1 flex-col gap-2">
